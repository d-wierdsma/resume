...
%%Begin%% Body
{
    ...
    \begin{tabularx}{\textwidth}{lp{16cm}X} 
        & \color{em-light} \faGenderless\space\space \color{darkgrey}{Maintained over 15,000 production Mattermost workspaces in Kubernetes responsible for \$1.5 million ARR. } & \\ [-5pt]
        ...
        & \color{em-light} \faGenderless\space\space \color{darkgrey}{Participated in cost cutting to reduce Mattermost Clouds spending by 40\%.} & \\ [-5pt]
        ...
        & \color{em-light} \faGenderless\space\space \color{darkgrey}{Participated in a weekly on-call rotation to triage and resolve issues.} & \\ [-10pt]
    \end{tabularx}\\
    }
