...
%%Begin%% Body
{
    ...
    \begin{tabularx}{\textwidth}{lp{16cm}X} 
        ...
        & \color{em-light} \faGenderless\space\space \color{darkgrey}{Upgraded existing Terraform resources from v0.11 to v0.12.} & \\ [-5pt]
        & \color{em-light} \faGenderless\space\space \color{darkgrey}{Maintained over one thousand AWS resources including EC2, ECS, Route53, Cloudformation services.} & \\ [-5pt]
        ...
        & \color{em-light} \faGenderless\space\space  \color{darkgrey}{Reviewed candidates and conducted interviews for the hiring of potential team members.} & \\ [-10pt]
    \end{tabularx}\\
    }
