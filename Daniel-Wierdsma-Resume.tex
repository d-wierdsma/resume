...
%%Begin%% Body
{
    ...
    \faCogs\space\space{\bfseries {\firamedium DevOps Tools}}    
        & {\color{darkgrey} \textbullet\space\space Bash, Git, Jenkins, Github Actions, NGINX, Splunk, Prometheus, Grafana, Istio, Linkerd} & \\[2pt]
    ...
    \hfill{\small{May 2020 to Present\\[-5pt]}} 
    \begin{tabularx}{\textwidth}{lp{16cm}X} 
        ...
        & \color{em-light} \faGenderless\space\space \color{darkgrey}{Created new environment for Shoppers Drug Mart Covid testing and vaccination forms to handle heavy load.} & \\ [-5pt]
        & \color{em-light} \faGenderless\space\space \color{darkgrey}{Implemented local kubernetes development environment using Skaffold and KinD.} & \\ [-5pt]
        ...
        & \color{em-light} \faGenderless\space\space \color{darkgrey}{Maintained existing, and created new AWS-hosted environments with resources including EC2, ECS, VPC, Route53, Cloudfront services.} & \\ [-5pt]
        & \color{em-light} \faGenderless\space\space \color{darkgrey}{Teaching and promoting DevOps practices to development teams to create a true DevOps culture.} & \\ [-10pt]
    \end{tabularx}\\
    }
