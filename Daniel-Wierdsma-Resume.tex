...
%%Begin%% Body
{
    ...
    \begin{tabularx}{\textwidth}{lp{16cm}X} 
        ...
        & \color{em-light} \faGenderless\space\space \color{darkgrey}{Upgraded over 50 existing Terraform modules and blueprints from v0.11 to v0.12 in order to ease load on Gitlab servers by moving resources to GCS.} & \\ [-5pt]
