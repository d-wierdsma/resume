...
%%Begin%% Body
{
    ...
    \begin{tabularx}{\textwidth}{lp{16cm}X} 
        ...
        & \color{em-light} \faGenderless\space\space \color{darkgrey}{Led team to create a highly scalable and cost-effective deployment solution for the company's Kubernetes services; leveraging over {\firamedium 150 ArgoCD Applications}} & \\ [-5pt]
    ...
    \begin{tabularx}{\textwidth}{lp{16cm}X} 
        ...
        & \color{em-light} \faGenderless\space\space \color{darkgrey}{Launched Shoppers Drug Mart COVID-19 testing and vaccination forms to over {\firamedium 5 million users}} & \\ [-5pt]
    ...
    \begin{LARGE}
        \color{em-light}\textbf{\\[-15pt]{\firamedium Education}\\[-20pt]}
    \end{LARGE}
